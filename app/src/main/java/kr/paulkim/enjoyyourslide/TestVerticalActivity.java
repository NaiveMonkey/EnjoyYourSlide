...
public class TestVerticalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Beer_VerticalViewPager verticalViewPager = (Beer_VerticalViewPager) findViewById(R.id.beer_verticalViewPager);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.activity_text_fragment, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.beer_textView);
