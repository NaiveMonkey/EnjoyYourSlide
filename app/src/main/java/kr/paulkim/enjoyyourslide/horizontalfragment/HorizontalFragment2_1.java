 ...
 */
public class HorizontalFragment2_1 extends Fragment implements FragmentLifeCycle {
    ...
    public static HorizontalFragment2_1 newInstance(int position) {
        Bundle args = new Bundle();
        args.putInt("position", position);
        HorizontalFragment2_1 fragment = new HorizontalFragment2_1();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*
        fragmentImage2_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                application.getViewPager().setCurrentItem(0, true);
            }
    ...
    public void OnResumeFragment() {
        getData("http://ksmr1102.vps.phps.kr/send_horizontal1.php");
    }
}
