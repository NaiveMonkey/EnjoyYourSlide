 ...
 */
public class HorizontalFragment4 extends Fragment implements FragmentLifeCycle {
    private MyApplication application;
    private ImageView fragment4;
    private ImageView backBtn;

    public static HorizontalFragment4 newInstance(int position) {
        Bundle args = new Bundle();
        args.putInt("position", position);
        HorizontalFragment4 fragment = new HorizontalFragment4();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragment4 = (ImageView) view.findViewById(R.id.fragmentImage2_3);
        ...
        //fragment4.setPadding(0, 110, 0, 0);
        application = (MyApplication) getActivity().getApplicationContext();
        String url = String.valueOf(application.getH_phoneList().get(2));
        Glide.with(this).load(url).into(fragment4);
